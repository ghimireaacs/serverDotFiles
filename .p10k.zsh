# Generated by Powerlevel10k configuration wizard on 2025-07-08 at 16:32 UTC.
...
# angled separators, blurred heads, flat tails, 2 lines, disconnected, full frame,
...
() {
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_SHOW_ON_COMMAND='(#m)kubectl|helm|kubens|kubectx|oc|istioctl|kogito|k9s|helmfile|flux|fluxctl|stern|kubeseal|skaffold|kubent|kubecolor|cmctl|sparkctl'
